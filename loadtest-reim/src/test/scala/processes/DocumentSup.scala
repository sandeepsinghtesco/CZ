  ...
  val document =
    ...
    .exec(http("Search_press")                                                              // Press search document button
      .post("/ReimViewController/faces/Home?Adf-Window-Id=w0&Adf-Page-Id=3")
        ...
        .formParam("pt1:contentAreaReg:0:tabrg2:2:pt1:ap1:qryId1:val90", "${Supplier_site}")
        .formParam("pt1:contentAreaReg:0:tabrg2:2:pt1:ap1:qryId1:val20", "4")
    ...
    //  println("Time")
    //  println(cTime)
    //  println("Supplier site number:")
    //  println(session("Supplier_site").as[String])
      print("Document: ")
