...
object Login {
  val login =
    ...
    .exec(http("Check_dashboard_3")
      .post("/ReimViewController/faces/Home?Adf-Window-Id=w0&Adf-Page-Id=3")
        .headers(headers_2)
        .formParam("org.apache.myfaces.trinidad.faces.FORM", "f1")
        .formParam("javax.faces.ViewState", "${ViewState}")
        .formParam("oracle.adf.view.rich.DELTAS", "{pt1:contentAreaReg:0:tabrg1:1:xp1={interval=-1}}")
        .formParam("event", "pt1:contentAreaReg:0:tabrg1:1:xp1")
        .formParam("event.pt1:contentAreaReg:0:tabrg1:1:xp1", """<m xmlns="http://oracle.com/richClient/comm"><k v="suppressMessageClear"><s>true</s></k><k v="type"><s>poll</s></k></m>""")
        .formParam("oracle.adf.view.rich.PROCESS", "pt1:contentAreaReg:0:tabrg1:1:xp1")
      .check(bodyString.saveAs("Answer"))
    )

    .exec(http("Check_dashboard_4")
      .post("/ReimViewController/faces/Home?Adf-Window-Id=w0&Adf-Page-Id=3")
        .headers(headers_2)
        ...
        .formParam("org.apache.myfaces.trinidad.faces.FORM", "f1")
        .formParam("javax.faces.ViewState", "${ViewState}")
        .formParam("event", "pt1:contentAreaReg:0:tabrg1:2:r1:0:p1")
        .formParam("event.pt1:contentAreaReg:0:tabrg1:2:r1:0:p1", """<m xmlns="http://oracle.com/richClient/comm"><k v="type"><s>poll</s></k></m>""")
        .formParam("oracle.adf.view.rich.PROCESS", "pt1:contentAreaReg:0:tabrg1:2:r1,pt1:contentAreaReg:0:tabrg1:2:r1:0:p1")
      .check(bodyString.saveAs("Answer"))
    )

    .exec(http("Check_dashboard_5")
      .post("/ReimViewController/faces/Home?Adf-Window-Id=w0&Adf-Page-Id=3")
        .headers(headers_2)
        .formParam("pt1:contentAreaReg:0:tabrg1:2:r1:0:r1:0:r1:0:pi1::_afrProcessState", "RUNNING")
        .formParam("pt1:contentAreaReg:0:tabrg1:2:r1:0:r2:0:r1:0:pi1::_afrProcessState", "RUNNING")
