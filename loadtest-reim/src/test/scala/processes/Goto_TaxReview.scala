...
object Goto_TaxReview {
  val goto_TaxReview =
    pause(1)                                                                                 // User pause
    .exec(http("Sidebar_Tax_Review")                                                          // Sidebar Tax Review List click
      .post("/ReimViewController/faces/Home?Adf-Window-Id=w0&Adf-Page-Id=2")
        ...
        .formParam("oracle.adf.view.rich.DELTAS", "{pt1:contentAreaReg:0:tabrg1:2:r1:0:r7:0:r1:1:statusMeterGauge1={_clientHeight=96,_clientWidth=64},pt1:contentAreaReg:0:tabrg1:2:r1:0:r7:0:r1:1:statusMeterGauge2={_clientHeight=96,_clientWidth=64},pt1:statusIndComp={visible=false}}")
        .formParam("event", "pt1:showMenuPanelDynRegion:1:taskItr:5:l9")
        .formParam("event.pt1:showMenuPanelDynRegion:1:taskItr:5:l9", """<m xmlns="http://oracle.com/richClient/comm"><k v="type"><s>action</s></k></m>""")
        .formParam("oracle.adf.view.rich.PROCESS", "pt1:showMenuPanelDynRegion,pt1:showMenuPanelDynRegion:1:taskItr:5:l9")
      .check(bodyString.saveAs("Answer"))
    )

    .pause(1)                                                                                 // User pause
    .exec(http("Sidebar_Tax_Review_Document")                                                 // Sidebar Tax Review Document Search click
      .post("/ReimViewController/faces/Home?Adf-Window-Id=w0&Adf-Page-Id=2")
        .headers(headers_2)
        .formParam("pt1:contentAreaReg:0:tabrg1:2:r1:0:r1:0:r1:0:pi1::_afrProcessState", "RUNNING")
        .formParam("pt1:contentAreaReg:0:tabrg1:2:r1:0:r2:0:r1:0:pi1::_afrProcessState", "RUNNING")
    ...
    .exec(http("Sidebar_Tax_Review_Document_Post")
      .post("/ReimViewController/faces/Home?Adf-Window-Id=w0&Adf-Page-Id=2")
        .headers(headers_2)
        .formParam("pt1:contentAreaReg:0:tabrg1:2:r1:0:r1:0:r1:0:pi1::_afrProcessState", "RUNNING")
        .formParam("pt1:contentAreaReg:0:tabrg1:2:r1:0:r2:0:r1:0:pi1::_afrProcessState", "RUNNING")
